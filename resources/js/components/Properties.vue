  ...
  <div class="el-tabs__inner">
    <form @submit.prevent.stop>
      <div class="w-full flex flex-wrap">
        ...
        <div class="w-full px-3 mb-3"
             v-if="activeField.hasOwnProperty('honeypotFieldName')"
        >
          <lnfb-input :label="__('honeypot_field_name')"
                      v-model="activeField.honeypotFieldName"/>
        </div>

        <div class="w-full px-3 mb-3"
             v-if="activeField.hasOwnProperty('honeypotFieldLabel')"
        >
          <lnfb-input :label="__('honeypot_field_label')"
        ...
        >
          ...
          <div class="lnfb-py-2">
              ...
              >
                <div class="flex">
                  ...
                  <div class="lnfb-w-1/5 lnfb-flex lnfb-flex-col lnfb-justify-center">
                    ...
                    >
                      <svg class="lnfb-fill-current lnfb-w-4 lnfb-h-4"
                           viewBox="0 0 20 20"
                      >
                        <path
            ...
            <LnfbBasicButton size="xs"
                             @click="addOption(activeField.options)"
            >
